...
def main_game():
    ...
    wordlist_level1 = ['universe', 'galaxy', 'milkyway',
                       'planet', 'star', 'comet']
    wordlist_level2 = ['astronaut', 'telescope', 'satellite',
                       'nebula', 'orbit', 'gravity']
    wordlist_level3 = ['constellation', 'interstellar', 'microgravity',
                       'blackhole', 'exoplanet', 'quasar']
  ...
  |_______|
    ...
    while (amount_of_timeswrong != max_wrongguesses and
           current_letters_right != len(randomword)):
        ...
        # check if the input is a valid alphabet and the length of the letter
